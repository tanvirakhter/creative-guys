      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Complete Digital Marketing <br className="hidden sm:block" />Solutions
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Everything you need to grow your brand and business in the digital space.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Engaging content that captures attention and drives action across all digital platforms."
            index={0}
          />
          <FeatureCard
          ...
          <FeatureCard
            ...
            description="End-to-end campaign execution that delivers measurable results and ROI."
            index={2}
          />
          <FeatureCard
          ...
          />
          <FeatureCard
            icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-6 sm:h-6"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path><path d="M22 12A10 10 0 0 0 12 2v10z"></path></svg>}
            title="Business Consultancy"
            description="Strategic guidance to optimize your digital presence and accelerate business growth."
            index={4}
          />
          <FeatureCard
            icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-6 sm:h-6"><path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z"></path><path d="M19 10v2a7 7 0 0 1-14 0v-2"></path><line x1="12" x2="12" y1="19" y2="22"></line></svg>}
            title="Full Digital Services"
            description="Comprehensive solutions for social media, SEO, PPC, email marketing, and more."
            index={5}
          />
        </div>
      </div>
